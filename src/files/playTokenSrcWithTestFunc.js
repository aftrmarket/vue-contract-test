async function handle (state, action) {
    ...
    if (input.function === "allow") {
      ...
      if (input.function === "count") {
        // Don't do anything, but the counter should increment b/c of the interaction
      }

      // Test function - See if this runs every time to modify the state
      if (Number.isInteger(state.counter)) {
        state.counter++;
      }
